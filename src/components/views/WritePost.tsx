    ...
    <Toast.Provider swipeDirection="right">
      <Toast.Root
        ...
        className={`
          ...
          z-[60] min-w-[300px] max-w-[450px] rounded-lg shadow-lg px-5 py-4
  ...
  return (
    <header className="fixed w-full left-0 top-0 flex items-center justify-between px-30 py-5 border-b border-neutral-300 bg-white z-30">
      <div className="flex items-center gap-3">
        ...
        <span className="text-xl font-semibold text-neutral-900">Write Post</span>
      </div>
...
export default function WritePost() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('https://blogger-wph-api-production.up.railway.app/posts', {
        method: 'POST',
        headers: {
      ...
      if (!res.ok) {
        ...
        setToastTitle('Failed to submit');
        setToastDesc(msg);
      ...
      setToastTitle('Post submitted successfully!');
      setToastDesc('');
      ...
      setToastTitle('Failed to submit post');
        ...
        <form className="flex flex-col gap-8 p-0" onSubmit={handleSubmit}>
              ...
              {editor && (
                <>
                  ...
                  <div className="flex items-center gap-1 border-b border-[#E5E7EB] px-4 py-2 bg-white z-20 sticky top-0">
                    ...
                    <Tooltip.Provider>
                      <Tooltip.Root>
                        ...
                        <Tooltip.Content
                          side="top"
                          className="bg-black text-white px-2 py-1 rounded text-xs z-50 cursor-pointer"
                          sideOffset={4}
                        >
                          Remove Link
                        </Tooltip.Content>
                  ...
                  <EditorContent
                    ...
                    `}
                    style={fullscreen ? {} : { minHeight: '160px' }}
                  />
                </>
              )}
            </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1 bg-red-100 text-red-600 rounded hover:bg-red-200 text-sm cursor-pointer"
                    >
                      Delete Image
                    </button>
                  </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className={`flex flex-wrap gap-2 border border-[#D1D5DB] rounded-[8px] px-4 py-3 ${errors.tags ? 'border-red-400' : ''}`}>
              {tags.map(tag => (
                <span key={tag} className="border border-gray-300 rounded px-2 py-1 flex items-center gap-1 text-sm">
                  {tag}
                  <button
                    type="button"
